...
1.  **Collecting and Combining Data**
    ...
    -   We loaded three separate text files (one per year: 2022, 2023, 2024) and row-bound them into a single dataset.

2.  **Cleaning the Data**

    -   We retained only the year, month, day and raw temperature columns.\
...
-   We calculated the average temperature for each combination of year and month.\
...
-   We then averaged those monthly values across all three years to create a long-term baseline for each calendar month.
